      ...
      <div data-reveal className="relative overflow-hidden rounded-[1.75rem] bg-ink p-10 md:p-14">
        ...
        <div className="relative grid items-center gap-8 md:grid-cols-[1.4fr_auto]">
          ...
          <a
            ...
            className="sheen inline-block justify-self-start rounded-full bg-accent-soft px-9 py-4 text-sm font-bold text-ink transition-[filter] duration-300 hover:brightness-110 md:justify-self-end"
          >
            Chamar no WhatsApp
          </a>
        </div>
